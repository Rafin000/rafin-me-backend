...
class Projects(db.Model):
    ...
    contributions = Column(ARRAY(String), default=[])
    ...
    def __init__(self, user_id, title, description=None, year=None, contributions=None, tech_stack=None, github_link=None, live_link=None, thumbnail_url=None):
        self.user_id = user_id
        self.title = title
